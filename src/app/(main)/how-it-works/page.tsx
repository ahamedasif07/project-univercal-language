...
export const metadata: Metadata = {
  title: "How It Works | Universal Language",
  description:
    "Discover Universal Language's 4-step target score roadmap: Diagnostic Evaluation, Algorithm Calibration, Simulation Mocks, and Guaranteed Milestone Execution.",
  alternates: {
    canonical: "https://universallanguage.com.bd/how-it-works",
  },
};
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Our proven 4-stage pedagogical framework reverse-engineered from Pearson&apos;s automated
              AI scoring system ensures you achieve your required score without wasting time or exam fees.
            </p>
          </div>
        </Container>
      </section>

      {/* ── 2. Official 4-Step Process Section ── */}
      <StepsSection />

      {/* ── 3. WhatsApp Diagnostic Callout ── */}
        ...
        <Container>
          <div className="max-w-3xl mx-auto p-8 sm:p-10 rounded-3xl bg-card border border-border/80 shadow-lg text-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-md mx-auto">
              Book your free 15-minute diagnostic profile audit with our Pearson-certified mentors today.
            </p>
            <div className="pt-2">
              <a
                href="https://wa.me/8801772224283?text=Hello%20Universal%20Language,%20I%20would%20like%20to%20start%20with%20Step%2001%20diagnostic%20audit."
                target="_blank"
              ...
              >
                <span>Book Step 01 on WhatsApp</span>
