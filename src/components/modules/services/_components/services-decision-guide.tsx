        ...
        <div className="max-w-3xl mx-auto">
            ...
            {DECISION_TREE.map((item, i) => (
              ...
              >
                <Link href={`/courses/${item.slug}`} className="block group focus:outline-none">
                  <div className={`flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5 p-4 sm:p-5 rounded-2xl border-l-4 border border-border/40 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 ${item.accent}`}>
                    {/* Question */}
          ...
          >
            <p className="text-sm text-muted-foreground mb-4">
              Still not sure? Our mentors will recommend the best option for you for free.
            </p>
            <a
