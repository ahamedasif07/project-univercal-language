      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 space-y-3.5">
          ...
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Which country are you targeting? Pearson PTE Academic is accepted by 3,000+ universities and government immigration authorities worldwide. Choose your destination below:
          </p>

          {/* Category Filter Tabs */}
          <div className="pt-3 flex flex-wrap items-center justify-center gap-2">
            {[
              { id: "all", label: "All Destinations (10)" },
              { id: "popular", label: "Most Popular (AU, UK, CA, US)" },
              { id: "europe", label: "Europe (Germany, Ireland)" },
              { id: "pacific", label: "Asia & Pacific (NZ, SG, UAE, JP)" },
            ].map((tab) => (
              <button
                key={tab.id}
                onClick={() =>
