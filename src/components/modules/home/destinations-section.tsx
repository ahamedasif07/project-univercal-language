...
export const DESTINATIONS: DestinationCountry[] = [
  {
    ...
    exams: [
      { name: "PTE Academic", score: "58+ / 65+ (Masters)", preferred: true, note: "Accepted by 100% of Australian universities & Dept of Home Affairs" },
      { name: "IELTS", score: "6.0+ / 6.5+ (Masters)", note: "Minimum 6.0 per band for university & student visa compliance" },
      { name: "TOEFL iBT", score: "79+ / 88+ (Masters)", note: "Accepted across Australian universities & Home Affairs" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "59+ / 65+ (Masters)", preferred: true, note: "Accepted by 99% of UK universities & UK Home Office SELT" },
      { name: "IELTS", score: "6.0+ / 6.5+ (Masters)", note: "Standard UKVI SELT requirement with min 5.5/6.0 per sub-score" },
      { name: "TOEFL iBT", score: "80+ / 90+ (Masters)", note: "Widely recognized by Russell Group and UK institutions" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "60+ / 65+ (Masters)", preferred: true, note: "Accepted by 100% of Designated Learning Institutions (DLIs) & SDS stream" },
      { name: "IELTS Academic", score: "6.0+ / 6.5+ (Masters)", note: "Full compliance for Canadian university admissions & SDS stream" },
      { name: "PTE Core", score: "CLB 7+ (60+)", preferred: true, note: "Official Pearson test approved by IRCC for Canadian PR & Express Entry" },
      { name: "TOEFL iBT", score: "83+ / 90+ (Masters)", note: "Accepted by top Canadian universities including UofT, UBC & McGill" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "54+ / 65+ (Masters)", preferred: true, note: "Accepted by Harvard, Yale, Stanford, Columbia & 1,500+ US institutions" },
      { name: "TOEFL iBT", score: "79+ / 90+ (Masters)", note: "Traditional US benchmark for undergraduate & graduate admission" },
      { name: "IELTS", score: "6.0+ / 6.5+ (Masters)", note: "Accepted by over 3,400 higher education institutions across the US" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "58+ / 65+ (Masters)", preferred: true, note: "Accepted by 100% of New Zealand universities & Immigration New Zealand (INZ)" },
      { name: "IELTS", score: "6.0+ / 6.5+ (Masters)", note: "Official academic pathway score for NZ universities and student visas" },
      { name: "TOEFL iBT", score: "80+ / 90+ (Masters)", note: "Accepted by all 8 New Zealand state universities" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "59+ / 66+ (Masters)", preferred: true, note: "Accepted by top TU9 technical universities & German consulate for English-taught degrees" },
      { name: "IELTS Academic", score: "6.0+ / 6.5+ (Masters)", note: "Standard English requirement for DAAD and international degree programs" },
      { name: "TOEFL iBT", score: "80+ / 92+ (Masters)", note: "Widely accepted across German public technical universities" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "58+ / 65+ (Masters)", preferred: true, note: "Recognized by top Asian universities including NUS, NTU, and global branch campuses" },
      { name: "IELTS", score: "6.0+ / 6.5+ (Masters)", note: "Standard academic entry requirement for Singapore universities" },
      { name: "TOEFL iBT", score: "85+ / 92+ (Masters)", note: "Accepted for both undergraduate and postgraduate degree admissions" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "58+ / 65+ (Masters)", preferred: true, note: "Accepted by all Irish universities and Irish Naturalisation and Immigration Service (INIS)" },
      { name: "IELTS", score: "6.0+ / 6.5+ (Masters)", note: "Standard requirement for Irish Stamp 2 student visa compliance" },
      { name: "TOEFL iBT", score: "80+ / 90+ (Masters)", note: "Recognized across Trinity College Dublin, UCD, and Irish colleges" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "50+ / 58+ (Masters)", preferred: true, note: "Accepted by top UK & Australian branch universities in Dubai" },
      { name: "IELTS", score: "5.5+ / 6.5+ (Masters)", note: "Standard English requirement across DIAC university campuses" },
      { name: "TOEFL iBT", score: "72+ / 82+ (Masters)", note: "Accepted for direct admission to international degree programs" },
    ],
    visas: [
  ...
  },
  {
    ...
    exams: [
      { name: "PTE Academic", score: "50+ / 58+ (Masters)", preferred: true, note: "Accepted for MEXT scholarships and English-medium degree programs" },
      { name: "IELTS", score: "5.5+ / 6.5+ (Masters)", note: "Standard entry test for English-track undergraduate and graduate study" },
      { name: "TOEFL iBT", score: "72+ / 82+ (Masters)", note: "Preferred by top national universities including Tokyo & Kyoto" },
    ],
    visas: [
          ...
          {activeCountry && (
            <div className="relative pb-8 flex flex-col justify-between min-h-full">
              ...
              <div className="px-6 pt-4 border-t border-border/60 bg-background/90 backdrop-blur-md sticky bottom-0 space-y-2">
                <a
                  href={`https://wa.me/8801772224283?text=Hello%20Universal%20Language,%20I%20am%20interested%20in%20studying%20or%20migrating%20to%20${encodeURIComponent(
                    activeCountry.name
